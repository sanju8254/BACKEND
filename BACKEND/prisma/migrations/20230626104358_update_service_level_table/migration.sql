/*
  ...
  - You are about to alter the column `created_by` on the `service_levels` table. The data in that column could be lost. The data in that column will be cast from `VarChar(15)` to `Int`.
...
*/
-- AlterTable
ALTER TABLE `service_levels` MODIFY `created_by` INTEGER NOT NULL DEFAULT 0,
